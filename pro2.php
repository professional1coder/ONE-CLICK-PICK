                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="images p-3">
                            <div class="text-center p-4"> <img id="main-image" src="./IMAGES/dishwasher.webp" width="250" /> </div>
                            <div class="thumbnail text-center"> <img onclick="change_image(this)" src="./IMAGES/dis1.jpg" width="70"> <img onclick="change_image(this)" src="./IMAGES/dis2.jpg" width="70"> </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="product p-4">
                            ...
                            <div class="mt-4 mb-3"> <span class="text-uppercase text-muted brand"></span>
                                <h5 class="text">Voltas Dish Washer</h5>
                                <div class="price d-flex flex-row align-items-center"> <span class="act-price"></span>
                                    <div class="ml-2"> <small class="dis-price"><h3><b>45,000/-</b></h3></small> </div>
                                </div>
                            </div>
                            <p class="about">Voltas Beko 8 Place Settings Table Top Dishwasher (DT8S, Silver, Inbuilt Heater)</p>
