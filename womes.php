...
<nav class="navbar navbar-expand-lg" style="background-color: #ccffd1;">
    ...
    <table border="0 " width="100% " bgcolor="white ">
        <tr>
            <th colspan="5 ">
                <center><h2>WOMENS T-SHIRT</h2></center>
                <hr>
            </th>
            <tr>
            <tbody>
                ...
                <?php
                  ...
                  $displayquery="SELECT image, username, price FROM womensshirt";
    ...
    <tr>
            ...
            <tbody>
                ...
                <?php
                  $con =mysqli_connect('localhost','root');
                  mysqli_select_db($con,'displayupload');
                  $displayquery="SELECT image, username, price FROM womenskurti";
    ...
    <tr>
            ...
            <tbody>
                ...
                <?php
                  $con =mysqli_connect('localhost','root');
                  mysqli_select_db($con,'displayupload');
                  $displayquery="SELECT image, username, price FROM saree";
    ...
    <tr>
            ...
            <tbody>
                ...
                <?php
                  $con =mysqli_connect('localhost','root');
                  mysqli_select_db($con,'displayupload');
                  $displayquery="SELECT image, username, price FROM womenslower";
