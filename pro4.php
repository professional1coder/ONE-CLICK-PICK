                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="images p-3">
                            <div class="text-center p-4"> <img id="main-image" src="./IMAGES/laptop.jpg" width="250" /> </div>
                            <div class="thumbnail text-center"> <img onclick="change_image(this)" src="./IMAGES/lap1.jpg" width="70"> <img onclick="change_image(this)" src="./IMAGES/lap2.jpg" width="70"> </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="product p-4">
                            ...
                            <div class="mt-4 mb-3"> <span class="text-uppercase text-muted brand"></span>
                                <h5 class="text">ASUS VIVOBOOK</h5>
                                <div class="price d-flex flex-row align-items-center"> <span class="act-price"></span>
                                    <div class="ml-2"> <small class="dis-price"><h3><b>55,000/-</b></h3></small> </div>
                                </div>
                            </div>
                            <p class="about">ASUS Vivobook 15, 15.6-inch (39.62 cms) FHD, AMD Ryzen 5 3500U, Thin and Light Laptop (8GB/512GB SSD/Integrated Graphics/Windows 11/Office 2021/Silver/1.8 kg),
                    M515DA-BQ512WS, Transparent Silver</p>
                            <div class="sizes mt-5">
                                <h6 class="text-uppercase">Colour</h6> <label class="radio"> <input type="radio" name="size" value="S" checked> <span>Gray</span> </label> <label class="radio"> <input type="radio" name="size" value="Brown"> <span>White</span> </label> <label class="radio"> <input type="radio" name="size" value="White"> <span>Black</span> </label> <label class="radio"> 
                            </div>
    ...
    <tr>
            ...
            <tbody>
                ...
                <?php
                  ...
                  $displayquery="SELECT image, username, price FROM relatedpro4 ";
