        ...
        <tr>
            ...
            <tbody>
                ...
                <?php
                  ...
                  $displayquery="SELECT image, username, price FROM tellg ";
    ...
    <tr>
            ...
            <tbody>
                ...
                <?php
                  $con =mysqli_connect('localhost','root');
                  mysqli_select_db($con,'displayupload');
                  $displayquery="SELECT image, username, price FROM telmi ";
    ...
    <tr>
            ...
            <tbody>
                ...
                <?php
                  $con =mysqli_connect('localhost','root');
                  mysqli_select_db($con,'displayupload');
                  $displayquery="SELECT image, username, price FROM pana ";
