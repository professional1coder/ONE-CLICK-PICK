...
<nav class="navbar navbar-expand-lg" style="background-color: #ccffd1;">
        ...
        <tr>
            ...
            <tbody>
                ...
                <?php
                  ...
                  $displayquery="SELECT image, username, price FROM bluetoothspeaker";
    ...
    <tr>
            <th colspan="5 ">
            <center><h2>BLUETOOTHSPEAKER</h2></center>
                <hr>
            </th>
            <tr>
            <tbody>
                ...
                <?php
                  $con =mysqli_connect('localhost','root');
                  mysqli_select_db($con,'displayupload');
                  $displayquery="SELECT image, username, price FROM soundbar ";
