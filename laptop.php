        ...
        <tr>
            ...
            <tbody>
                ...
                <?php
                  ...
                  $displayquery="SELECT image, username, price FROM laptop ";
    ...
    <tr>
            ...
            <tbody>
                ...
                <?php
                  $con =mysqli_connect('localhost','root');
                  mysqli_select_db($con,'displayupload');
                  $displayquery="SELECT image, username, price FROM desktop ";
