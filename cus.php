        ...
        <tr>
            ...
            <tbody>
                ...
                <?php
                  ...
                  $displayquery="SELECT image, username, price FROM customize ";
            ...
            <td>
                ...
                <a href="customize2.php"><button class="btn btn-primary text-uppercase mr-2 px-4">Buy Now</button></a>
            </td>
    ...
    <tr>
            ...
            <tbody>
                ...
                <?php
                  $con =mysqli_connect('localhost','root');
                  mysqli_select_db($con,'displayupload');
                  $displayquery="SELECT image, username, price FROM customize1 ";
