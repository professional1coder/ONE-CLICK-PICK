                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="images p-3">
                            <div class="text-center p-4"> <img id="main-image" src="./IMAGES/Refrigerators.webp" width="500" /> </div>
                            <div class="thumbnail text-center"> <img onclick="change_image(this)" src="./IMAGES/ref1.jpg" width="200"> <img onclick="change_image(this)" src="./IMAGES/ref2.jpg" width="200"> </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="product p-4">
                            ...
                            <div class="mt-4 mb-3"> <span class="text-uppercase text-muted brand"></span>
                                <h5 class="text">LG Refrigerator</h5>
                                <div class="price d-flex flex-row align-items-center"> <span class="act-price"></span>
                                    <div class="ml-2"> <small class="dis-price"><h3><b>20,000/-</b></h3></small> </div>
                                </div>
                            </div>
                            <p class="about">LG 215L 3 Star Direct-Cool Single Door Refrigerator (GL-D221ABCD, Blue Charm, Base stand with drawer)
                    Visit the LG Store</p>
    ...
    <tr>
            ...
            <tbody>
                ...
                <?php
                  ...
                  $displayquery="SELECT image, username, price FROM relatedpro5 ";
